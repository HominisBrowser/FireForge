 ...
 * `Packaged:` summary can say what it skipped and why. This replaces a run
 * reporting `4 missing` with zero real misses.
 */
 ...
 * `support-files` matcher's narrowness: `**` and other cross-directory
 * shapes are not accepted, because a carve-out that silently widens is the
 * failure this feature is warned against.
 *
 * @param sourcePath - Engine-relative POSIX path
