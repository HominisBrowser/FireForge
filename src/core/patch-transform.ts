 ...
 * forward-import rule, which scans content for import statements, and a
 * binary blob authors none, so omitting it contributes exactly what
 * including it would. Refusing instead (which is what
