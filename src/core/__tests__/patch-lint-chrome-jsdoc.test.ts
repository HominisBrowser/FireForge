...
describe('validateChromeScriptJsDoc', () => {
  ...
  it("flags methods missing JSDoc at the configured severity when classMethodMode='warning'", () => {
    ...
    expect(methodIssue?.message).toContain('HominisDock');
